<template>
  <div>
    ...
    <el-card>
      <el-table v-loading="loading" :data="followList" stripe @selection-change="handleSelectionChange">
        <el-table-column align="center" type="selection" width="55"></el-table-column>
        <el-table-column align="center" label="序号" type="index" width="70"></el-table-column>
        <el-table-column align="center" label="关注者ID" prop="followerId"></el-table-column>
        <el-table-column align="center" label="被关注者ID" prop="followedId"></el-table-column>
...
export default {
  ...
  methods: {
    getPage () {
      ...
      getFollowPage(this.queryParams).then(res => {
    ...
    handleSave () {
      this.$refs.formRef.validate(valid => {
        if (!valid) return
        saveFollow(this.form.data).then(res => {
          if (res.code === 200) {
